...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        // ---
        val DogImage: ImageView = view!!.findViewById(R.id.card_image)
        val DogName: TextView = view!!.findViewById(R.id.card_text_dog_name)
        val DogAge: TextView = view!!.findViewById(R.id.card_text_dog_age)
        val DogHobby: TextView = view!!.findViewById(R.id.card_text_dog_hob)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        return if (layout == Layout.GRID){
            // create new view using grid_list_item
